...
public class SkillList {
    ...
    private void init() { // -_-
        Skill skill = new Skill(1, 10, 20, SkillType.RANGED, ClassType.MAGE, 0, "FireBall", 100, 2, 1, 0, 2);
        fireBall = new Ranged(skill, 0, 0, 50, 50, 100, null, SkillEntityType.MFIRE, 5);
        skill = new Skill(1, 8, 30, SkillType.RANGED, ClassType.MAGE, 1, "FrostBall", 150, 1, 1, 0, 2);
        frostBolt = new Ranged(skill, 0, 0, 50, 50, 80, null, SkillEntityType.MFIRE, 4);
        skill = new Skill(1, 20, 50, SkillType.AOE, ClassType.MAGE, 2, "FireWall", 100, 5, 5, 1, 2);
        fireWall = new AoE(200, 0, 0, 20, 5, null, 5, 2, 0, skill, SkillEntityType.MFIRE);
        skill = new Skill(1, 5, 50, SkillType.SHIELD, ClassType.MAGE, 3, "FireShield", 0, 5, 2, 1, 0);
        fireShield = new Shield(skill, SkillEntityType.MFIRE, 100, 80);
        skill = new Skill(1, 4, 55, SkillType.SHIELD, ClassType.MAGE, 4, "FrostShield", 0, 4, 2, 1, 0);
        frostShield = new Shield(skill, SkillEntityType.MFROST, 100, 80);
        skill = new Skill(1, 10, 10, SkillType.SHIELD, ClassType.MAGE, 5, "StrengthBuff", 0, 5, 5, 0, 0);
        ...
        skill = new Skill(1, 10, 10, SkillType.SHIELD, ClassType.MAGE, 6, "IntellegenceBuff", 0, 5, 5, 0, 0);
