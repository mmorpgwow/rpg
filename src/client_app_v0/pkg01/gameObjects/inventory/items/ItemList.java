...
public class ItemList {
    ...
    private void init() {
        ...
        legs = new Armor(3, "Legs", 200, 4, stats);
         stats = new Stats(0, 5, 5, 0, 0, 5);
        hands = new Armor(4, "Hands", 200, 4, stats);
         stats = new Stats(0, 5, 2, 0, 0, 0);
        boots = new Armor(5, "Boots", 100, 2, stats);
         stats = new Stats(0, 5, 2, 0, 0, 8);
        belt = new Armor(6, "Belt", 200, 4, stats);
         stats = new Stats(0, 10, 0, 0, 0, 10);
        neck = new Armor(7, "Neck", 500, 10, stats);
         stats = new Stats(0, 10, 0, 0, 0, 10);
        ring = new Armor(8, "Ring", 500, 10, stats);
